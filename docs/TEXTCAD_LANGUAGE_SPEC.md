...
`struct`, `container`, `fn`, `let`, `for`, `in`, `with`, `if`, `else`, `or`, `and`, `return`, `true`, `false`, `unit`, `unit_prefix`
...
- **Keywords**: `struct`, `container`, `fn`, `let`, `for`, `in`, `with`, `if`, `else`, `or`, `and`, `return`, `true`, `false`, `unit`, `unit_prefix`
- **Syntax**: Struct definitions, function definitions, with statements, for loops, dot prefix notation, unit definitions
- **Semantics**: Constraint-based assignment, entity vs reference distinction, container semantics, transform pattern, compile-time dimensional analysis
