...
impl<'src> From<AddLhs<'src>> for CmpRhs<'src> {
    fn from(add: AddLhs<'src>) -> Self {
        match add {
            ...
            AddLhs::Deref { inner, span } => CmpRhs::Deref { inner, span },
...
impl<'src> From<AddLhs<'src>> for CmpLhs<'src> {
    fn from(add: AddLhs<'src>) -> Self {
        match add {
            ...
            AddLhs::Deref { inner, span } => CmpLhs::Deref { inner, span },
...
impl<'src> From<MulLhs<'src>> for AddRhs<'src> {
    fn from(mul: MulLhs<'src>) -> Self {
        match mul {
            ...
            MulLhs::Deref { inner, span } => AddRhs::Deref { inner, span },
...
impl<'src> From<MulLhs<'src>> for AddLhs<'src> {
    fn from(mul: MulLhs<'src>) -> Self {
        match mul {
            ...
            MulLhs::Deref { inner, span } => AddLhs::Deref { inner, span },
...
impl<'src> From<PowLhs<'src>> for PowRhs<'src> {
    fn from(pow: PowLhs<'src>) -> Self {
        match pow {
            ...
            PowLhs::Deref { inner, span } => PowRhs::Deref { inner, span },
...
impl<'src> From<PowLhs<'src>> for MulRhs<'src> {
    fn from(pow: PowLhs<'src>) -> Self {
        match pow {
            ...
            PowLhs::Deref { inner, span } => MulRhs::Deref { inner, span },
...
impl<'src> From<PowLhs<'src>> for MulLhs<'src> {
    fn from(pow: PowLhs<'src>) -> Self {
        match pow {
            ...
            PowLhs::Deref { inner, span } => MulLhs::Deref { inner, span },
